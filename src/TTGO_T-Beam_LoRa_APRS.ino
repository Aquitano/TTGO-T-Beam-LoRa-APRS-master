...
void setup()
{
  ...
  if ((digitalRead(BUTTON) == LOW) || (Tcall == "XX9XXX-0"))
  { // into setup when no real data entered in TTGO...config.h
  ...
  // gps
  Serial.println("Configuring GPS dynamic mode");
  writedisplaytext("LoRa-APRS", "", "Init:", "dyn mode", "", "", 3000);
...
// set dynamic mode 6 (airborne <1g)
// taken from https://ava.upuaut.net/?p=750
// which is derived from https://github.com/cuspaceflight/joey-m/tree/master/firmware
// thank you Anthony Stirk, Jon Sowman
